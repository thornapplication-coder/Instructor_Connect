  ...
  return {
    ...
    infoEntries: [
      ...
      },
      {
        id: 'i3',
        type: 'text',
        title: 'FFS A320: Sidestick-Sensor Bay 1 gemeldet',
        description: 'Bekannter Defekt — Workaround bis zur Reparatur.',
        body: 'Der Sidestick der linken Seite in Bay 1 zeigt sporadisch Roll-Spikes. Für Trainings mit Schwerpunkt Manual Flying bitte Bay 2 buchen. Reparatur ist bestellt, Termin folgt.',
      ...
      },
      {
        id: 'i4',
        type: 'pdf',
        title: 'OM Part D — Revision 4 freigegeben',
        description: 'Aktuelle genehmigte Fassung des Trainingshandbuchs.',
        fileName: 'sample.pdf',
    ...
    feedbackEntries: [
      {
        ...
        authorId: 'u-anna',
        category: 'IT / Technik',
        recipient: 'SIM Technik (technik@instructorconnect.at)',
        urgent: true,
        message: 'Der Beamer im Briefingraum 2 fällt seit gestern immer wieder aus — heute Nachmittag sind dort zwei Briefings geplant.',
        attachment: { name: 'beamer-fehler.jpg', kind: 'image', sizeMB: 1.8 },
        createdAt: now - 5 * h,
      },
      {
        id: 'fb2',
        ...
        recipient: 'Training Admin (trainingadmin@instructorconnect.at)',
        urgent: false,
        message: 'Vorschlag: Die Sim-Slots am Freitagnachmittag früher veröffentlichen, dann lässt sich die Anreise besser planen.',
        createdAt: now - 2 * d,
      },
    ],
    starredInfo: { 'u-anna': ['i2'] },
    contacts: [
    ...
    settings: {
      ...
      feedbackRecipients: [
        'Training Admin (trainingadmin@instructorconnect.at)',
        'Office (office@instructorconnect.at)',
        'SIM Technik (technik@instructorconnect.at)',
        'HR (hr@instructorconnect.at)',
      ],
    ...
    gradingRecords: [
      ...
      },
      {
        ...
        formTypeId: '306',
        instructorId: 'u-stefan',
        header: { aircraftType: 'B737', location: 'Sim Center', event: 'TR Session 4 — Additional Training', date: iso(now - 4 * d) },
        trainees: [],
        sessionStatus: null,
        freeText: {
          'State exercises marked with grade "2" or below': 'PRO (2), FPM (2), WLM (2) — TR Session 4 vom Vortag.',
          'Description of deficiency': 'Engine-out-Handling und Workload-Priorisierung unter Belastung nicht stabil.',
          'Description of agreed retraining': 'Zusatzsession 90 Minuten mit Fokus auf EFATO und Checklisten-Timing.',
        },
        signatureInstructor: SIG, signatureTrainee: SIG,
