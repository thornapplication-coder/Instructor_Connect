...
export function UpdateBanner() {
  ...
  return (
    <div className="pointer-events-auto flex w-full max-w-lg items-center justify-center gap-3 rounded-2xl bg-accent px-4 py-3 text-body font-semibold text-bg shadow-soft">
